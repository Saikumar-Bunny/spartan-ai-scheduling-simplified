...
from spartan_ai_scheduling_simplified.PhysicalStorageClasses import Slab, Furnace, WaitingBay
...
class ExperienceReplay:
    ...
    def add_elements(self, experience: Tuple[Experience]):
    ...
    def sample_elements(self, sample_size: int) -> Tuple[List[State], List[Action], List[Reward], List[State], List[bool]]:
        ...
        for exp in sample_list:
            states[i], actions[i], rewards[i], new_states[i], dones[i] = \
